        ...
        if (selectedImageUri != null) {
            ...
            fileRef.putFile(selectedImageUri)
                    .addOnSuccessListener(taskSnapshot -> fileRef.getDownloadUrl().addOnSuccessListener(uri -> {
                        ...
                        saveUpdatedItem(name, price, category, imageUrl);
                    }))
                    .addOnFailureListener(e -> Toast.makeText(getContext(), "Hiba képfeltöltéskor: " + e.getMessage(), Toast.LENGTH_SHORT).show());
        } else {
            saveUpdatedItem(name, price, category, furnitureItem.getImageUrl());
        }
    }

    private void saveUpdatedItem(String name, int price, String category, String imageUrl) {
        furnitureItem.setName(name);
        furnitureItem.setPrice(price);
        furnitureItem.setCategory(category);
        furnitureItem.setImageUrl(imageUrl);
